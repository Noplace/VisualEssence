...
#ifndef GRAPHICS_FONT_BMFONT_LOADER_H
#define GRAPHICS_FONT_BMFONT_LOADER_H
...
{
public:
	Loader(FILE *f, Font *font, const char *fontFile);
...
{
public:
	BinaryLoader(FILE *f, Font *font, const char *fontFile);
